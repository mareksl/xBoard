...
import { GrpcMessage, RecursivePartial } from '@ngx-grpc/core';
...
export class UninterpretedOption implements GrpcMessage {
    ...
    while (reader.nextField()) {
      ...
      switch (reader.getFieldNumber()) {
        ...
        case 3:
          ...
          break;
        case 4:
          instance.positiveIntValue = reader.readUint64();
          break;
        case 5:
          instance.negativeIntValue = reader.readInt64();
          break;
        case 6:
  ...
  static toBinaryWriter(instance: UninterpretedOption, writer: BinaryWriter) {
    ...
    if (instance.positiveIntValue) {
      writer.writeUint64(4, instance.positiveIntValue);
    }
    if (instance.negativeIntValue) {
      writer.writeInt64(5, instance.negativeIntValue);
    }
  ...
  private _positiveIntValue?: number;
  private _negativeIntValue?: number;
  ...
  get positiveIntValue(): number | undefined {
    return this._positiveIntValue;
  }
  set positiveIntValue(value: number | undefined) {
    this._positiveIntValue = value;
  }
  get negativeIntValue(): number | undefined {
    return this._negativeIntValue;
  }
  set negativeIntValue(value: number | undefined) {
