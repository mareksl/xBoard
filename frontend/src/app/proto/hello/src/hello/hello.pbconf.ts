...
/*
  ...
  @NgModule({
    providers: [
      { provide: GRPC_HELLO_SERVICE_CLIENT_SETTINGS, useValue: grpcSettings },
    ],
  })
  export class GrpcConfigModule { }
*/
export const GRPC_HELLO_SERVICE_CLIENT_SETTINGS = new InjectionToken<
  GrpcClientSettings
>('GRPC_HELLO_SERVICE_CLIENT_SETTINGS');
