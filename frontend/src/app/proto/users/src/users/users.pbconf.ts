...
/*
  ...
  @NgModule({
    providers: [
      { provide: GRPC_USERS_SERVICE_CLIENT_SETTINGS, useValue: grpcSettings },
    ],
  })
  export class GrpcConfigModule { }
*/
export const GRPC_USERS_SERVICE_CLIENT_SETTINGS = new InjectionToken<
  GrpcClientSettings
>('GRPC_USERS_SERVICE_CLIENT_SETTINGS');
